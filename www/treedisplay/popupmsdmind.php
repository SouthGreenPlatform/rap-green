...
$result = mysqli_query($link,"SELECT c.*, b.* FROM bioentity_crossreference bc inner join cross_reference c on c.ID_CrossReference=bc.ID_CrossReference left outer join biblio b on b.Id_Biblio=c.Id_RefBiblio where c.`Database_name`='".$_REQUEST['tag']."' and bc.ID_Bioentity=".$_REQUEST['id']);
